...
namespace _05.ByteBank
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                System.Console.WriteLine("Aconteceu um problema na transferencia");
    ...
    class TransferenciaBancaria : ITransferenciaBancaria
    {
            ...
            , decimal valor)
        {
            if(contaDebito == null)
            {
                throw new ArgumentMullException("contaDebito");
            }
            if(contaCredito == null)
            {
                throw new ArgumentMullException("contaCredito");
            }
            if(valor <= 0)
            {
