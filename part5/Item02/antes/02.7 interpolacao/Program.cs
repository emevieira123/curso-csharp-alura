...
Cláusula 1ª - O EMPREGADO prestará ao EMPREGADOR, a partir de {contrato.Inicio} e assinatura deste instrumento, seus trabalhos exercendo a função de {contrato.Cargo:d}, prestando pessoalmente o labor diário no período compreendido entre {contrato.InicioJornada:t} e {contrato.FimJornada:t}, e intervalo de 1 hora para almoço;
